...
Everything is ready to use only set your app access token in callback_controller
<code>def url<br>"https://graph.facebook.com/v2.6/me/messages?access_token=?"<br>end</code>
